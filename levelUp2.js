function every(){
var answers = ["no thats not gonna do it","No thats not gonna do it", "NO THATS NOT GONNA DO I"];
...
function every4(){
var answers = ["have a good weekend", "Have a goood weekend", "HAVE A GOOD WEEKEND"];
var question = document.getElementById("question").value.toLowerCase();
if(question === ""){
  alert('Nothing was entered');
  }else{
...
function every6(){
var answers = ["maybe next time huh", "Maybe next time huh", "MAYBE NECT TIME HUH"];
var question = document.getElementById("question").value.toLowerCase();
if(question === ""){
  alert('Nothing was entered');
  }else{
...
function every8(){
var answers = ["i cant believe i let you", "I cant believe i let you", " ICANT BELIEVE I LET YOU"];
var question = document.getElementById("question").value.toLowerCase();
if(question === ""){
  alert('Nothing was entered');
  }else{
